...
/* harmony import */ var _store_reducers_socket_reducer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../../store/reducers/socket.reducer */ "./src/app/store/reducers/socket.reducer.ts");
...
/* harmony import */ var _store_actions_socket_actions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./../../store/actions/socket.actions */ "./src/app/store/actions/socket.actions.ts");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var src_app_store_reducers_user_reducer__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/store/reducers/user.reducer */ "./src/app/store/reducers/user.reducer.ts");
...
function ChatComponent_div_5_div_4_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtextInterpolate"](contact_r6.userName);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵadvance"](2);
...
function ChatComponent_div_5_div_4_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("ngForOf", ctx_r4.contacts);
} }
...
class ChatComponent {
    ...
    ngOnInit() {
        this.store.select(src_app_store_reducers_user_reducer__WEBPACK_IMPORTED_MODULE_6__["getUser"])
            ...
            if ((user && !this.user) || (user && this.user && this.user._id !== user._id)) {
                ...
                this.store.dispatch(new _store_actions_socket_actions__WEBPACK_IMPORTED_MODULE_3__["GetUserRooms"]());
            }
            this.user = user;
        });
        this.store.select(_store_reducers_socket_reducer__WEBPACK_IMPORTED_MODULE_1__["getUserRooms"])
            .subscribe((userRooms) => this.userRooms = userRooms);
        // get messages from server
        // this.store.dispatch(new GetMessages());
        // on changes messages state
        this.store.select(_store_reducers_socket_reducer__WEBPACK_IMPORTED_MODULE_1__["getActiveContactMsgs"])
            .subscribe((msgs) => this.msgs = msgs);
        this.store.select(_store_reducers_socket_reducer__WEBPACK_IMPORTED_MODULE_1__["getActiveContact"])
            .subscribe((activeContact) => this.activeContact = activeContact);
        this.socketService.onSocketEvent('msg')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["tap"])((msg) => console.log('msg', msg)))
            .subscribe((msg) => this.store.dispatch(new _store_actions_socket_actions__WEBPACK_IMPORTED_MODULE_3__["GetMessagesSuccess"]({ msgs: [msg] })));
        this.store.select(_store_reducers_socket_reducer__WEBPACK_IMPORTED_MODULE_1__["getContacts"])
            .subscribe((contacts) => {
        ...
        this.socketService.onSocketEvent('activeSockets')
            ...
            this.store.dispatch(new _store_actions_socket_actions__WEBPACK_IMPORTED_MODULE_3__["ActiveSockets"]({ activeSockets }));
        });
        ...
        this.inpMsgEvent$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["fromEvent"])(this.inpMsg.nativeElement, 'input');
        this.inpMsgEvent$
    ...
    loginAnonymous() {
        ...
        this.store.dispatch(new _store_actions_user_actions__WEBPACK_IMPORTED_MODULE_2__["LoginAnonymous"](name));
    ...
    ngAfterViewChecked() {
        this.scrollTop();
        if (this.inpName) {
            this.inpNameEvent$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["fromEvent"])(this.inpName.nativeElement, 'input');
            this.inpNameEvent$
                .subscribe((inputEvent) => {
    ...
    joinRoom(requestedUser_id) {
        this.socketService.emitSocketEvent('joinRoom', { requestedUser_id });
    }
    startChat(contact) {
        this.joinRoom(contact.user_id);
        console.log('contact', contact);
        this.store.dispatch(new _store_actions_socket_actions__WEBPACK_IMPORTED_MODULE_3__["GetActiveContactMsgs"]({ activeContact: contact }));
    }
    logout() {
...
ChatComponent.ɵfac = function ChatComponent_Factory(t) { return new (t || ChatComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_ngrx_store__WEBPACK_IMPORTED_MODULE_7__["Store"]), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_services_socket_service__WEBPACK_IMPORTED_MODULE_8__["SocketService"]), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_services_user_service__WEBPACK_IMPORTED_MODULE_9__["UserService"])); };
ChatComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({ type: ChatComponent, selectors: [["app-chat"]], viewQuery: function ChatComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        var _t;
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵqueryRefresh"](_t = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵloadQuery"]()) && (ctx.chatMessages = _t.first);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵqueryRefresh"](_t = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵloadQuery"]()) && (ctx.inpMsg = _t.first);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtemplate"](5, ChatComponent_div_5_Template, 8, 1, "div", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtext"](6, "\n    ");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function ChatComponent_Template_button_click_26_listener() { return ctx.send(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtext"](27, "Send");
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("ngForOf", ctx.msgs);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵadvance"](14);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("disabled", !ctx.textValidation);
    } }, directives: [_angular_common__WEBPACK_IMPORTED_MODULE_10__["NgIf"], _angular_common__WEBPACK_IMPORTED_MODULE_10__["NgForOf"], _angular_common__WEBPACK_IMPORTED_MODULE_10__["NgClass"]], pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_10__["JsonPipe"]], styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL21vZHVsZXMvY2hhdC9jaGF0LmNvbXBvbmVudC5zY3NzIn0= */"] });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵsetClassMetadata"](ChatComponent, [{
    ...
    }], function () { return [{ type: _ngrx_store__WEBPACK_IMPORTED_MODULE_7__["Store"] }, { type: _services_socket_service__WEBPACK_IMPORTED_MODULE_8__["SocketService"] }, { type: _services_user_service__WEBPACK_IMPORTED_MODULE_9__["UserService"] }]; }, { chatMessages: [{
